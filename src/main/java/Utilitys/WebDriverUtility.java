	...
	import org.openqa.selenium.support.ui.WebDriverWait;
		...
		public class WebDriverUtility {
			 ...
			 public void handleDropdownByValue(WebElement element,String value)
			{
			 ...
			 /**
			  * This method will handle dropdown by two values 
			  * @param element
			  * @param value
			  */	 
...
//				File storingFolder=new File("\\C:\\Users\\Ayesha\\OneDrive\\Desktop\\X-YUG All Files\\Eclipse Workspace X_Yug\\Goldsikka  Screenshots\\"+methodName+".png");   //This is to store inside local system
			...
			/**
			 * This method will take Model Pop Up Screen Shot
			 * @param driver
